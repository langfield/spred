...
stock_data["Average_ld"] = np.log(stock_data['Average']) - np.log(stock_data['Average']).shift(1)
stock_data["Volume_ld"] = np.log(stock_data['Volume']) - np.log(stock_data['Volume']).shift(1)
#stock_data.head(2)
