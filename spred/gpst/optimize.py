...
def objective(trial: optuna.Trial) -> float:
    ...
    args.warmup_steps = trial.suggest_discrete_uniform('warmup_steps', 10000, 60000, 10000)
    ...
    config['layer_norm_epsilon'] = trial.suggest_loguniform('layer_norm_epsilon', 1e-12, 5e-5)
